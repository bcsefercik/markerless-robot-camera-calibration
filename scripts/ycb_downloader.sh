...
for val in ${StringArray[@]}; do
   wget "http://ycb-benchmarks.s3-website-us-east-1.amazonaws.com/data/berkeley/${val}/${val}_berkeley_rgbd.tgz" -P "/kuacc/users/bsefercik/dataset/ycb/" && tar -xvf "/kuacc/users/bsefercik/dataset/ycb/${val}_berkeley_rgbd.tgz" -C /kuacc/users/bsefercik/dataset/ycb/ &
done
wait
# for val in ${StringArray[@]}; do
#    tar -xvf "${val}_berkeley_rgbd.tgz"
# done
