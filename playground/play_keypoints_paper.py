...
if __name__ == "__main__":
    ...
    kinect_frame = copy.deepcopy(frame).translate([0.01, 0, 0])
    ...
    color = 'F1C40F'
    ee_rgb = rgb[ee_idx] * 0.9
    # ee_rgb = ee_rgb + np.array((int(color[0:2], 16), int(color[2:4], 16), int(color[4:], 16))) / 255
    ...
    pcd.points = o3d.utility.Vector3dVector(new_ee_points)
    pcd.colors = o3d.utility.Vector3dVector(ee_rgb)
    ...
    o3d.visualization.draw_geometries(
        ...
        [pcd, ee_frame, kinect_frame, ref_shapes]
